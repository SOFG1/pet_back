...
todosRouter.post("/", checkAuth, addTodoValidator, handleValidationErrors, todosController.httpAddTodo);
todosRouter.delete("/:id", checkAuth, todosController.httpDeleteTodo);
todosRouter.patch("/:id", checkAuth, addTodoValidator, handleValidationErrors, todosController.httpEditTodo);
